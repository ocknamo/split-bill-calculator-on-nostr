 ...
 * - cap: H(invite_token || NUL || pubkey) - proves knowledge of invite_token
 *        NUL separator prevents hash collisions [C2]
 */
...
/**
 * Calculates the capability cap = H(invite_token || NUL || pubkey)
