...
export async function createSettlement(
  ...
  const { settlementId, inviteToken, name, currency } = params;
  const relays = params.relays ? [...params.relays] : [...DEFAULT_RELAYS];
...
export class SettlementSync {
  ...
  constructor(options: SettlementSyncOptions) {
    const { settlementId, inviteToken, relays } = options;
    this.#settlementId = settlementId;
    this.#inviteToken = inviteToken;
    this.#relays = relays ? [...relays] : [...DEFAULT_RELAYS];
