 ...
 * - cap: H(invite_token || '\0' || pubkey) - proves knowledge of invite_token
 */
...
/**
 * Calculates the capability cap = H(invite_token || '\0' || pubkey)
 * [C2] '\0' separator prevents hash collision between different splits of the same string
 */
